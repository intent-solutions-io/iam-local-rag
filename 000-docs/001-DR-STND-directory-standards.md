...
├── 6767-a-DR-STND-document-filing-system-standard-v4.md   # 6767 canonical docs
├── 6767-b-DR-INDEX-standards-catalog.md
└── 6767-c-AA-TMPL-after-action-report-template.md
```
...
6767-a-DR-STND-document-filing-system-standard-v4.md
6767-b-DR-INDEX-standards-catalog.md
6767-c-INLINE-DR-STND-inline-source-deployment-for-vertex-agent-engine.md
```
